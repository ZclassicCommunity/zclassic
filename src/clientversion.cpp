 ...
 */
const std::string CLIENT_NAME("ZClassic");

/**
 * Client version number
 */
#define CLIENT_VERSION_SUFFIX "-ZClassic"
...
{
    if (nVersion % 100 < 25)
        return strprintf("%d.%d.%d-ZIP209-beta%d", nVersion / 1000000, (nVersion / 10000) % 100, (nVersion / 100) % 100, (nVersion % 100)+1);
    if (nVersion % 100 < 50)
