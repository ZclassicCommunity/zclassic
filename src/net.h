...
/** Maximum length of incoming protocol messages (increased to 64 MiB for snapshot chunks). */
static const unsigned int MAX_PROTOCOL_MESSAGE_LENGTH = 64 * 1024 * 1024;
